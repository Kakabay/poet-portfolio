  ...
  return (
    <>
      ...
      <AnimatePresence>
        {active && (
          <>
            <WindowPopup className="hidden md:block" setActive={setActive}>
              <LoginWindow />
            </WindowPopup>
      ...
      <AnimatePresence>{burger && <MedBurger setBurger={setBurger} />}</AnimatePresence>
      ...
      <header className="pt-4 xl:pt-6 flex flex-col gap-4">
        <div className="xl:hidden relative p-4 md:px-6 container overflow-hidden h-20 w-[328px] md:w-[768px] shadow-bottom">
          ...
          <div className="flex leading-[120%] justify-between  items-center">
            ...
            <div className="flex items-center gap-4">
              <EnterBtn className="!hidden md:!flex" setActive={setActive} setMode={setMode} />
        ...
        <div className="xl:flex hidden relative z-50 items-end container justify-between">
          ...
          <EnterBtn setActive={setActive} setMode={setMode} />
        </div>
