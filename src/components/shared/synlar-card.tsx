...
const SynlarCard = ({ position_author_review, categ, review_author, btnText }: Props) => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <div>
        ...
        <p className="group-hover:text-PRIM h-[100px] line-clamp-3">{position_author_review}</p>
      </div>
