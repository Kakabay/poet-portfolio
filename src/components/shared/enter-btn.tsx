...
const EnterBtn = ({ className }: { className?: string }) => {
  return (
    <button
      className={cn(
        'md:flex hidden xl:hidden gap-2 text-[14px] text-PRIM font-medium items-center font-inter py-2.5 px-4 border-[1.5px] rounded-[4px] h-10 border-OUTLINE',
        className,
      )}>
      <svg
        width="16"
