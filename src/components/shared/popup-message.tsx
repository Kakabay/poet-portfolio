  ...
  return (
    ...
    >
      <div
        ref={ref}
        className={cn(
          "absolute md:py-[52px] py-8 w-[328px] md:h-[232px] z-50 h-[168px] md:w-[408px] md:px-6 px-4 top-1/2 -translate-x-1/2 left-1/2 -translate-y-1/2 shadow-bottom"
        )}
      >
        ...
        <div className="flex flex-col md:gap-4 gap-2 text-center">
          ...
          <h6 className="md:text-16 text-[14px] leading-[145%] h-6 -tracking-wide">
            {text}
          </h6>
