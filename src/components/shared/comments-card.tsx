...
const CommentsCard = ({ text, print, categ, author }: Props) => {
  return (
    <div className="px-6 relative pt-12 pb-[52px] syn-hover flex flex-col gap-6 group shadow-bottom card-hover after:comments-1-path w-[384px] h-[414px]">
      ...
      <div className="flex flex-col justify-between h-full">
        <div className="text-[14px] leading-[140%] mb-9">
          ...
          <h6 className="text-ON_SURFACE_VAR font-medium italic">AGU neşirýat, kopiraýter</h6>
        </div>
