...
const Burger = ({ setBurger }: Props) => {
  ...
  return (
    <motion.div
      ...
      className="fixed z-[100] md:hidden top-0 left-0 overflow-y-auto pointer-events-auto  right-0 w-full bg-SURFACE_CONTAINER h-full">
      <div className="flex flex-col gap-6 py-4 container">
        ...
        {token ? (
          <User className="" active={openUser} setActive={setOpenUser} />
        ) : (
          <EnterBtn className="" setActive={setMobActive} setMode={setMode} />
        )}
