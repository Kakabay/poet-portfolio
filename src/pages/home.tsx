          ...
          <div className="px-8 md:px-14 w-full pb-20 md:pt-16 pt-12 flex flex-col relative z-20 md:gap-6 gap-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[12px] md:text-[14px] font-medium md:font-normal leading-[130%] md:leading-[145%] -tracking-wide">
                ...
                maslahatlarňyzy hem-de belliklerňizi öz döredijiligimde ulanyp biljekdigme çäksiz
                buýsanýaryn. <br /> Bizden daşlaşmaň! Biziň sahypamyza ýazylmagy unutmaň! <br /> Uly
                hormat bilen,
              </p>
            ...
            <div className="flex flex-col gap-4">
              <h3 className="kaushan text-PRIM text-[18px] md:text-[24px] leading-[130%]">
                “Saňa onki süňňüm bilen siňsedim”, <br /> Diýýän seň öňüňde dyz epip, Şygyr! <br />{' '}
                Dury bulak bolup, kalba eňsediň, <br /> Ýaşasadym senden bagt tapyp, Şygyr!
              </h3>
              <h5 className="text-[12px] md:text-[14px] text-right font-medium md:font-normal leading-[130%] md:leading-[145%] -tracking-wide">
                Ezizgeldi Helleňow, “Baý göwnüm” kitaby, Aşgabat 2024 ý, “Şygyrýet” atly goşgydan,
                42-nji sahypa
              </h5>
            </div>
          </div>
