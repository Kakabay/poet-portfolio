  ...
  return (
    <PageLayout
      ...
      <section className="flex flex-col gap-12">
        <h2 className="h2 kaushan text-center">Ynha meniň geçen durmuş ýolum:</h2>

        <div className="flex gap-6 items-center relative">
          <TextRomb text="Çagalyk we mekdep ýyllarym" />
          <img src="/images/about/arrow.svg" alt="" className="absolute top-0 left-[13.5%]" />
          ...
          <img src="/images/about/arrow.svg" alt="" className="absolute top-0 right-[35%]" />
