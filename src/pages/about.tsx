  ...
  return (
    <PageLayout
      ...
      <section className="flex flex-col gap-6 xl:gap-12">
        ...
        <div className="flex xl:flex-row flex-col xl:gap-6 items-center relative">
          ...
          <img
            ...
            alt=""
            className={cn('absolute xl:bottom-0 bottom-[185px] xl:right-[15%] right-[150px]')}
          />
      ...
      <InfoBlock
        ...
        imgClassName="xl:w-[286px] xl:h-[309px] size-full"
      ...
      <section className="flex flex-col overflow-visible">
        ...
        <Carousel opts={{ align: 'start' }} className="xl:hidden overflow-visible">
